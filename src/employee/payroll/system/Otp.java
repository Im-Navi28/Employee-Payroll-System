...
public class Otp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("You've just recieved a OTP on your registered mobile number.");

        jLabel2.setFont(new java.awt.Font("Bell MT", 1, 24)); // NOI18N
        jLabel2.setText("Please enter it below to login");
 ...
 if (txtPhone.getText().equals("8124455167")) {
        JOptionPane.showMessageDialog(null, "OTP Sent");
    }//GEN-LAST:event_jButton2ActionPerformed
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if (txtVerOTP.getText().equals("12468")) {
        JOptionPane.showMessageDialog(null, "Sucess");
        MainMenu km = new MainMenu();
        km.setVisible(true);
        this.dispose();
    } else  {
    ...
    private static class JJOptionPane {

        private static void showMessageDialog(Object object, String otp_Sent) {
